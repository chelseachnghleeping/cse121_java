...
function output(temples) {
    temples.forEach((temple) => {
        ...
        let templeName = document.creareElement("h3");
...
const sortBy = () => {
    ...
    switch (filter) {
        case 'templeName Ascending':
            output(
                templeList.sort((temple1, tempple2) => {
                    ...
                    else if (templeName1 > tempple2) return 1;
                    else return 0;
                })
            );
            break;
        ...
        case 'templeYearDedicated':
            output(
                templelist.sort((temple1, temple) => {
                    let templeDate1 = templeDate1.dedicated;
